      ...
      <div id="post-body" class="metabox-holder columns-2">
        ...
        <div id="postbox-container-1" class="postbox-container">
          <div id="side-sortables" class="meta-box-sortables ui-sortable">
            ...
            <div id="load_template" class="postbox">
              ...
              <div class="misc-pub-section">
                <select id="id_sh_template" style="width: 100%">
                  ...
                  <option value="poll">Minimalistic</option>
                  <option value="poll_demo">Classic: logo, demos</option>
                  <option value="poll_map">Classic: map</option>
                  <option value="poll_demo_map">Advanced: logo, demos, map</option>
                </select>
              </div>
              <div class="misc-pub-section">
                <a href="http://blog.sodahead.com/?p=210"
                   style="float:left; height: 25px; line-height:25px;"
                  target="_blank">Preview Templates</a>
                <div id="publishing-action">
                  <input type="button" onclick="SodaHead.load_template()<?php
                    if($template_id) echo";SodaHead.fix_css($template_id);"; ?>"
                         class="button"
            ...
            <div id="load_poll" class="postbox">
              <div class="handlediv" title="Click to toggle"><br></div>
            ...
            <div id="load_demo" class="postbox">
              <div class="handlediv" title="Click to toggle"><br></div>
